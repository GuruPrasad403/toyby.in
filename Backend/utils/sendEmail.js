...
<body>
    <div class="email-container">
        ...
        <div class="email-header">
            ...
            <p>Your trusted destination for quality toys</p>
        </div>
        ...
        <div class="email-content">
            ...
            <p>Dear User,</p>
            <p>We are thrilled to have you join <strong>Toyby</strong>. To get started, please verify your account by using the OTP below:</p>
            <div class="otp">${otp}</div>
            <p>This OTP is valid for <strong>10 minutes</strong>. If you did not request this, please ignore this email.</p>
            <p>Thank you for choosing <strong>Toyby</strong>.</p>
        </div>

        <!-- Footer -->
        <div class="email-footer">
            <p>&copy; 2024 Toyby. All Rights Reserved.</p>
            <p>
